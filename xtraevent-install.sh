...
sleep 2
echo "These settings will save posters in hdd , usb or mmc"
echo "Be sure to mount your storage as hdd , usb or mmc"
init 4
sleep 3
if os.path.exists("/media/hdd"):
	...
	echo "Posters will be saved in hdd"
	...
	echo "Posters will be saved in usb"
	...
	sed -i "/xtraEvent/d" $SETTINGS
			{
				...
				echo "config.plugins.xtraEvent.imgNmbr=2"
				echo "config.plugins.xtraEvent.info=false"
				echo "config.plugins.xtraEvent.loc=/media/mmc/"
				echo "config.plugins.xtraEvent.searchNUMBER=8"
				echo "config.plugins.xtraEvent.searchType=movie"
				echo "config.plugins.xtraEvent.timerHour=2"
				echo "config.plugins.xtraEvent.timerMod=Period"
	...
	echo "Posters will be saved in mmc"
# ============================================================================================================
sleep 2
sync
echo ""
